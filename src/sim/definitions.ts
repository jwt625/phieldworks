export type Kind='extractor'|'assembler'|'generator'|'reference'|'junction'|'crossing'|'tuner'|'emitter'|'dump'|'sentry'|'fabrication-cell';
...
export const DEFS:Record<Kind,Definition>={
 ...
 crossing:{name:'Two-layer crossing',w:2,h:2,cost:6,watts:0,ports:['A','B','C','D'],description:'Two independent wave layers cross without joining: A↔C and B↔D pass straight through.'},
